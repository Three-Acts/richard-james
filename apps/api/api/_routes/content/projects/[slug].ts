import { getProjectContentBySlug } from "../../../_lib/content.js";
...
/** GET /api/content/projects/:slug -> ProjectContent. Public, unauthenticated. */
export default withApi(["GET"], async (request, response) => {
  ...
  ok(response, await getProjectContentBySlug(slug));
});
